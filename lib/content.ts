...
export const projects: Project[] = [
  {
    ...
    screenshots: [
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/shelterlab-homepage.png", alt: "ShelterLab home feed" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/shelterlab-loginpage.png", alt: "ShelterLab .ac.kr email login" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/shelterlab-profilepage.png", alt: "ShelterLab user profile with LabCred score" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/shelterlab-sellpage.png", alt: "ShelterLab sell listing flow" },
    ],
    placeholder: false,
  },
  {
    ...
    repoUrl: undefined,
    screenshots: [
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/hrms-loginpage.png", alt: "HR Management System login" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/hrms-timeinpage.png", alt: "HR Management System time in/out entry" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/hrms-historypage.png", alt: "HR Management System entry history" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/hrms-leavepage.png", alt: "HR Management System leave request" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/hrms-otleavepage.png", alt: "HR Management System overtime & leave" },
    ],
    placeholder: false,
    internal: true,
  },
  {
    ...
    screenshots: [
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/LLK-1.png", alt: "Lyn's Little Kitchen homepage hero" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/LLK-2.png", alt: "Lyn's Little Kitchen product listing and kitchen story" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/LLK-3.png", alt: "Lyn's Little Kitchen order steps overview and footer" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/LLK-4.png", alt: "Lyn's Little Kitchen how-to-order page with step-by-step guide" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/LLK-5.png", alt: "Admin dashboard with sales, orders, and stock overview" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/LLK-6.png", alt: "Admin products page listing cookies with stock and status" },
    ],
    placeholder: false,
  },
  {
    ...
    screenshots: [
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/TF-1.webp", alt: "That Fridge home dashboard with fridge inventory and crew" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/TF-2.webp", alt: "That Fridge quick chat answering what to cook tonight" },
      { src: "https://keemi-spaces-1.sgp1.cdn.digitaloceanspaces.com/images/TF-3.webp", alt: "That Fridge recipe suggestions from crew tab" },
    ],
    placeholder: false,
  },
];
